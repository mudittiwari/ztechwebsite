...
function News() {
    return (
        <>
        <Mainslider/>
            <div id="maindiv" style={{'position':'relative','top':'750px'}}>
            <div className="container-fluid">
                ...
                <div className="row mx-0 w-100 d-flex justify-content-center my-5 pb-5">
                        <div className="col-11 mb-5 pb-5 d-flex justify-content-center">
